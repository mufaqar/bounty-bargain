...
const PopularCategories = ({ categories, setIsCategory }: any) => {
     return (
          <>
               <div className='fixed top-[78px] rounded-md max-w-[480px] w-full bg-[#F6F9FF] shadow-md p-6 pr-0 z-[100]'>
               ...
               <div className="bg-transparent fixed inset-0 top-20" onClick={()=>setIsCategory(false)}/>
          </>
     )
}
