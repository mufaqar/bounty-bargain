...
console.log("🚀 ~ RateUs ~ id:", id)
     ...
     const handleRating = async (star: any) => {

          const grandRating = (data.grandRating + star) / 2
          var tokenWithWriteAccess = "skP2S7MCtS3jgy2tHbkxY6JpgaMAwJxDv9Lp94WL2e5bRci5jHBXlOQiymO6UIq9KMRvmHaDLvlQg3vKz8x8omnTGAp35aQfWrA29gEHU1PLoTdaGDWVBu7pG5X4W5Aeoz737jZ0nmZeVFZdHzUJnaH23VVcjN3dVrizmxMkUnfpHrAHdxS8"
          // setLoading(true)
          // client
